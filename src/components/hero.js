  ...
  return (
    <div className={styles.hero}>
      ...
      <div className={styles.hero__subtitles}>
        ...
        <h2 className={`${styles.hero__subtitle} ${loaded ? "displayed" : ""}`}>
          {lang === "fr"
            ? "Développeur full-stack de Montréal"
            : "Full-stack developer from Montreal"}
        </h2>
      </div>
